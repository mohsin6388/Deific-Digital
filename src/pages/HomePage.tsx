...
const features = [
  {
    ...
    desc: "End-to-end tracking with full transparency — you always know where your project stands.",
  },
  {
    icon: Users,
    title: "Dedicated Expert Team",
    desc: "A hand-picked team of developers, designers, and strategists assigned exclusively to your project.",
  },
  {
    icon: Timer,
    title: "On-Time, Every Time",
    desc: "Agile methodology ensures your project ships on schedule — no delays, no excuses.",
  },
  {
    icon: Zap,
    title: "Fast Delivery",
    desc: "Rapid sprints and lean workflows mean you go live sooner without sacrificing quality.",
  },
  {
    icon: BadgeCheck,
    title: "Quality Assured",
    desc: "Every project undergoes rigorous QA testing before delivery — zero compromise on standards.",
  },
  {
    icon: Star,
    title: "5-Star Rated",
    desc: "Consistently rated 5 stars by 550+ happy clients worldwide.",
    stars: true,
  },
];
...
const services = [
  {
    ...
    desc: "Design and develop a creative website with our microscopic detailing and scrupulous strategies.",
    link: "/services/startup-idea-validation",
  },
  {
    icon: Code2,
    title: "Fast MVP Development",
    desc: "Minimum Viable Product (MVP) development services designed to cater to a diverse range of businesses.",
    link: "/services/mvp-developmen",
  },
  {
    icon: BarChart3,
    title: "Digital Marketing",
    desc: "Data-driven strategies to grow your online presence and generate leads.",
    link: "/services/search-engine-optimization",
  },
  {
    icon: Smartphone,
    title: "Mobile Apps",
    desc: "Native & cross-platform iOS/Android apps that deliver seamless user experiences.",
    link: "/services/android-app-development",
  },
  {
    icon: Bot,
    title: "AI Solutions",
    desc: "Smart automation and AI-driven business solutions to streamline operations.",
    link: "/services/ai-integration-service",
  },
  {
    icon: Cloud,
    title: "Cloud & DevOps",
    desc: "Scalable cloud infrastructure and CI/CD pipelines for enterprise reliability.",
...
const testimonials = [
  {
    ...
    text: "Deific Digital transformed our vision into reality. Outstanding quality and on-time delivery every time.",
    rating: 5,
  },
  {
    name: "Priya Sharma",
    role: "CTO, FinanceApp",
    text: "Their expertise in React and Node.js helped us scale from 1K to 100K users seamlessly.",
    rating: 5,
  },
  {
    name: "Amit Singh",
    role: "Founder, EduTech Platform",
    text: "Best IT partner we've ever worked with. Professional, responsive, and truly talented team.",
    rating: 5,
  },
];
...
const certTags = [
  ...
  {
    label: "Clutch Top Company",
    color: "#B91C1C",
    to: "https://clutch.co/profile/deific-digital",
  },
  { label: "ISO 9001 Certified", color: "#B91C1C" },
  { label: "Google Partner", color: "#4285F4" },
  { label: "AWS Partner", color: "#FF9900" },
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, padding: "12px 12px 36px", overflow: "hidden" }}>
        ...
        {[
          { label: "Mobile Apps", pct: 85, color: "#B91C1C" },
          { label: "Web Projects", pct: 70, color: "#8B5CF6" },
          { label: "AI Solutions", pct: 60, color: "#10B981" },
        ].map((b) => (
      ...
      >
        {["🏠 Home", "📊 Stats", "🔔 Alerts", "👤 Profile"].map((n) => (
          <div
            ...
            style={{
              textAlign: "center",
              color: n.startsWith("🏠") ? "#B91C1C" : "#656464",
...
function MobileGameScreen() {
  ...
  useEffect(() => {
    const t = setInterval(
      () => setScore((s) => s + Math.floor(Math.random() * 50)),
      800,
    );
    ...
    >
      ...
      >
        {Array.from({ length: 10 }).map((_, i) => (
          <div key={i} style={{ textAlign: "center", fontSize: 14 }}>
            {i % 3 === 0 ? "👾" : i % 3 === 1 ? "🛸" : "🔵"}
          </div>
        ))}
      </div>
...
function WebScreen() {
  return (
    ...
    >
      ...
      >
        <span style={{ color: "#B91C1C", fontWeight: 900, fontSize: 11 }}>
          Deific<span style={{ color: "#111" }}>Digital</span>
        </span>
      ...
      >
        ...
        >
          We Build Digital
          <br />
          <span style={{ color: "#B91C1C" }}>Engines That Scale</span>
        </div>
      ...
      >
        {[
          { icon: "💻", title: "Web Apps", color: "#B91C1C" },
          { icon: "🛒", title: "E-Commerce", color: "#8B5CF6" },
          { icon: "📊", title: "Dashboards", color: "#0EA5E9" },
          { icon: "🔗", title: "APIs & CMS", color: "#10B981" },
        ].map((s) => (
          <div
            key={s.title}
            style={{
...
function AIScreen() {
  ...
  const responses = [
    "📊 Q3 revenue up 34% — mobile segment leads!",
    "🤖 Detected 3 growth opportunities.",
    "⚡ Automating report generation now...",
  ];
  ...
  useEffect(() => {
    const t = setInterval(() => {
      setMsgs((m) => [
        ...m.slice(-4),
        { from: "ai", text: responses[idxRef.current % responses.length] },
      ]);
      idxRef.current++;
    }, 2500);
    return () => clearInterval(t);
  ...
  return (
    ...
    >
      <div
        style={{ background: "#10B981", padding: "10px 14px", color: "#fff" }}
      >
        <div
          style={{
            display: "flex",
      ...
      >
        {[
          ...
          <div key={l} style={{ textAlign: "center" }}>
            <div style={{ color: "#10B981", fontWeight: 800, fontSize: 10 }}>
              {v}
            </div>
      ...
      >
        {msgs.slice(-4).map((m, i) => (
          ...
          >
            <div
              style={{
                background: m.from === "ai" ? "#fff" : "#10B981",
                color: m.from === "ai" ? "#111" : "#fff",
                borderRadius:
                  m.from === "ai" ? "4px 12px 12px 12px" : "12px 4px 12px 12px",
                padding: "6px 10px",
                fontSize: 9,
                maxWidth: "78%",
                boxShadow: "0 1px 4px rgba(0,0,0,0.08)",
                border: m.from === "ai" ? "1px solid #d1fae5" : "none",
              }}
            >
              {m.text}
            </div>
...
function PhoneFrame({ children }: { children: React.ReactNode }) {
  return (
    <div
      style={{ position: "relative", width: 230, height: 460, flexShrink: 0 }}
    >
      <div
        style={{
          position: "absolute",
      ...
      <div
        style={{
          ...
          padding: 4,
          boxShadow:
            "0 0 0 1px #333, 0 28px 80px rgba(0,0,0,0.5), inset 0 0 0 1px #555",
        }}
      >
        <div
          style={{
        ...
        >
          ...
          >
            <div
              style={{ paddingTop: 32, height: "100%", position: "relative" }}
            >
              {children}
            </div>
          </div>
...
function TabletFrame({ children }: { children: React.ReactNode }) {
  return (
    <div
      style={{ position: "relative", width: 300, height: 440, flexShrink: 0 }}
    >
      <div
        style={{
          width: "100%",
      ...
      >
        ...
        >
          ...
          >
            <div
              style={{ paddingTop: 28, height: "100%", position: "relative" }}
            >
              {children}
            </div>
          </div>
...
function LaptopFrame({ children }: { children: React.ReactNode }) {
  return (
    <div
      style={{ position: "relative", width: 380, height: 300, flexShrink: 0 }}
    >
      <div
        style={{
          width: "100%",
      ...
      >
        <div
          style={{
            ...
            padding: 8,
            boxShadow: "0 0 0 1px #333, 0 28px 80px rgba(0,0,0,0.4)",
          }}
        >
          <div
            style={{
...
function MonitorFrame({ children }: { children: React.ReactNode }) {
  return (
    <div
      style={{ position: "relative", width: 400, height: 320, flexShrink: 0 }}
    >
      <div
        style={{
          width: "100%",
...
const slides = [
  {
    ...
    stats: [
      { val: "550+", lbl: "Apps Built" },
      { val: "5★", lbl: "Avg Rating" },
      { val: "48h", lbl: "Fast Delivery" },
    ],
  ...
  },
  {
    ...
    stats: [
      { val: "80+", lbl: "Games Built" },
      { val: "4.9★", lbl: "Store Rating" },
      { val: "10M+", lbl: "Downloads" },
    ],
  ...
  },
  {
    ...
    stats: [
      { val: "24/7", lbl: "AI Uptime" },
      { val: "90%", lbl: "Automation" },
      { val: "10×", lbl: "ROI Boost" },
    ],
...
function HeroSlider() {
  ...
  const renderDeviceFrame = (children: React.ReactNode, device: string) => {
    const configs: Record<
      string,
      { w: number; h: number; minW: number; maxW: number; vw: number }
    > = {
  ...
  return (
    <>
      ...
      <div
        className="cert-strip-container"
        style={{
          background: "#fff",
            ...
            <Link to={tag.to}>
              <div
                ...
                style={{
                  ...
                  gap: 7,
                  background: "#fff",
                  border: `1.5px solid ${tag.color}22`,
                  borderRadius: 99,
                  padding: "5px 16px",
                  boxShadow: `0 2px 8px ${tag.color}12`,
                  whiteSpace: "nowrap",
                  flexShrink: 0,
                  marginRight: 12,
                }}
            ...
            >
              ...
              <span
                style={{
                  ...
                  borderBottom: `4px solid ${slide.accent}40`,
                  paddingBottom: 4,
                }}
              >
          ...
          >
            <div
              style={{
                position: "absolute",
                inset: -30,
                background: `radial-gradient(ellipse,${slide.accent}22 0%,transparent 70%)`,
                pointerEvents: "none",
                borderRadius: "50%",
              }}
            />
            ...
            {slide.floatLabels.map((label, i) => (
              <div
                ...
                style={{
                  position: "absolute",
                  ...label.pos,
                  background: label.text.includes("★")
                    ? "#fff"
                    : label.text.includes("🏆")
                      ? slide.accent
                      : "#fff",
                  borderRadius: 14,
                  padding: "7px 14px",
                  boxShadow: label.text.includes("★")
                    ? "0 4px 20px rgba(0,0,0,0.12)"
                    : label.text.includes("🏆")
                      ? `0 4px 20px ${slide.accent}40`
                      : "0 4px 20px rgba(0,0,0,0.12)",
                  border: label.text.includes("★")
                    ? "1px solid #f0f0f0"
                    : "none",
                  fontSize: 11,
                  fontWeight: 700,
...
function ChatBot() {
  ...
  const [messages, setMessages] = useState([
    {
      from: "bot",
      text: "Hey there! 👋 I'm Deific Digital's assistant. Ask me about our services, experience, clients, or how to get a free quote!",
    },
  ]);
              ...
              >
                <div
                  style={{
                    ...
                    lineHeight: 1.5,
                    boxShadow:
                      m.from === "bot" ? "0 1px 4px rgba(0,0,0,0.08)" : "none",
...
export default function HomePage() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Deific Digital – IT Company | Web Development & Digital Marketing
          Experts
        </title>
        <link rel="canonical" href="https://deificdigital.com" />
        <meta
          name="description"
          content="Professional IT services for businesses including web development, mobile apps, SEO, Google Ads, branding, software development, and cloud hosting."
        />
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <div className="text-left mb-6">
                <span className="inline-block rounded-full border border-red-200 bg-white px-4 py-1 text-xs font-bold uppercase tracking-widest text-red-600 mb-3">
                  Who We Are
                </span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-black tracking-tight leading-[1.2] text-gray-900 mb-5">
                Building the Digital{" "}
                <span className="text-red-600">Future</span>,<br />
                One <span className="text-red-600">Solution</span> at a Time.
              </h2>
              <p className="text-gray-500 text-[15px] leading-[1.8] mb-4">
                Deific Digital is a renowned{" "}
                <span className="text-gray-800 font-semibold">IT company</span>{" "}
                that was established in 2014 and has its headquarters in Noida,
                India. In the last ten years, our company has managed to become
                one of the{" "}
                ...
                <span className="text-gray-800 font-semibold">
                  more than 550 businesses globally
                </span>{" "}
                and offer them effective web, mobile, AI, and digital marketing
                solutions. Being a highly skilled{" "}
                <span className="text-gray-800 font-semibold">
                  software company
                </span>
                , we create digital solutions for businesses and help them grow
                effectively.
              </p>
              <p className="text-gray-500 text-[15px] leading-[1.8] mb-7">
                We are a team of professionals who care about the success of our
                clients. Having{" "}
                <span className="text-gray-800 font-semibold">
                  12+ years of experience
                </span>{" "}
                and having a 98% satisfaction rate, we do not only follow the
                latest digital trends but also help our clients shape them.{" "}
              </p>
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <div
                  key={i}
                  className={`relative overflow-hidden rounded-2xl ${s.card} border border-white/60 p-4 flex flex-col items-center justify-center text-center`}
                >
                  <div
                    className="absolute inset-0 rounded-2xl pointer-events-none"
                    style={{
                      background: `radial-gradient(circle at 60% 30%, ${s.glow} 0%, transparent 70%)`,
                    }}
                  />
                  <div className="w-8 md:w-10 mb-4 relative z-10">
                    <img src={s.icon} alt="" />
                  </div>
                  <div className="text-xl md:text-2xl font-black text-gray-900 leading-none relative z-10">
                    {s.val}
                  </div>
                  <div className="text-[9px] md:text-[11px] font-semibold text-gray-500 mt-1 leading-[1.4] relative z-10">
                    {s.lbl[0]}
                    <br />
                    {s.lbl[1]}
                  </div>
        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
            {services.map((s) => (
              <div
                key={s.title}
                className="group relative bg-white rounded-2xl border border-gray-200 p-6 hover:border-red-100 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-red-100/40 transition-all duration-300 overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-black text-[20px] text-gray-900 leading-tight">
                    {s.title}
                  </h3>
                  ...
                  <Link
                    to={s.link}
                    className="mt-5 inline-flex items-center gap-1 text-[13px] font-bold text-red-600 group/link"
                  >
                    <span className="border-b border-dashed border-red-300 group-hover/link:border-red-600 transition-colors">
                      Learn more
                    </span>
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-3 md:mb-5">
              <span className="inline-block rounded-full border border-red-200 bg-white px-4 py-1 text-xs font-bold uppercase tracking-widest text-red-600 mb-6">
                Why Choose US
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900">
                Businesses <span className="text-red-600">Trust</span> Deific
                Digital
              </h2>
            </div>
            ...
            <h2 className="text-xl sm:text-4xl font-black tracking-tight leading-[1.2] text-gray-900 mb-3">
              ...
              We're Your <span className="text-red-600">Growth Engine.</span>
            </h2>
            <p className="text-gray-500 text-[15px] leading-relaxed max-w-2xl mb-10">
              Whether it is due to AI-enabled solutions or 24x7 delivery
              support, Deific Digital has emerged as one of the best{" "}
              <span className="text-gray-800 font-semibold">
            ...
            <div className="relative overflow-hidden bg-red-50 border border-red-200 rounded-2xl p-4 sm:p-5 mb-8 mt-10">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row lg:items-center gap-5">
                ...
                <div className="flex-1 min-w-0">
                  <span className="inline-block bg-red-600 text-white text-[12px] font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider mb-4">
                    Our Own Product
                  </span>
                  ...
                  <p className="text-sm text-gray-600 mt-2 leading-relaxed max-w-2xl">
                    ...
                    helps businesses generate high-quality customer reviews,
                    strengthen their online reputation, and improve local search
                    visibility, making it easier to rank higher on Google
                    Business Profile and attract more customers.
                  </p>
                </div>

                <button>
                  <a
                    href="https://reviewninjapro.com"
                    className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                  >
            ...
            {/* Product 2 - AI Chatbot Solutions */}
            <div className="relative overflow-hidden bg-red-50 border border-red-200 rounded-2xl p-4 sm:p-5 mb-6 shadow-sm hover:shadow-md hover:border-red-300 transition-all duration-300">
              <div className="absolute right-0 top-0 w-32 h-32 rounded-full bg-red-100 -translate-y-1/2 translate-x-1/2 pointer-events-none" />
              ...
              <div className="relative z-10 flex flex-col lg:flex-row lg:items-center gap-5">
                ...
                {/* Product Content */}
                <div className="flex-1 min-w-0">
                  <span className="inline-block bg-red-600 text-white text-[12px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wider mb-3">
                    Our Own Product
                  </span>
                  ...
                  <p className="text-sm text-gray-600 mt-2 leading-relaxed max-w-2xl">
                    Intelligent AI-powered chatbot solutions designed to
                    automate conversations, improve customer engagement, and
                    help businesses streamline their daily operations.
                  </p>

                  {/* Chatbot Feature Boxes */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mt-4">
                    {/* AI WhatsApp Chatbot */}
                    <div className="flex items-center gap-3 bg-white border border-red-100 rounded-xl p-3 hover:border-red-300 transition-colors">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold text-white bg-red-600 hover:bg-red-700 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 shrink-0"
                >
                  Explore Solutions
