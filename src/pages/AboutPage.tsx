...
// import atul from "../assets/team-5.jpeg";
// import shobhit from "../assets/team-3.jpeg";
// import hridyansh from "../assets/team-2.jpeg";
// import mohit from "../assets/team-mohit.jpeg";
// import shoaib from "../assets/team-4.jpeg";
// import mohsin from "../assets/team-6.jpeg";
// import cover from "../assets/cover-image.png";
// import { useState, useEffect, useRef } from "react";
// import { ChevronLeft, ChevronRight, Sparkles, Quote, Users, Award, Globe, Briefcase } from "lucide-react";
...
//   // Get visible team members (3 at a time, but we'll show 1 on mobile, 2 on md, 3 on lg)
//   // For simplicity, we'll show 3 at a time on large screens, 2 on medium, 1 on small.
//   // We'll use CSS grid with overflow hidden and transform.
//   // Instead, we'll use a simple sliding container with translateX.

//   // We'll create a wrapper that holds all members and translates based on index.
//   // But we have to show multiple at once. We'll display 3 cards per slide.
//   // We'll group them into chunks of 3.
//   const chunkSize = 3;
//   const totalGroups = Math.ceil(totalSlides / chunkSize);
//   const currentGroup = Math.floor(currentIndex / chunkSize);
//   const startIdx = currentGroup * chunkSize;
//   const visibleMembers = teamMembers.slice(startIdx, startIdx + chunkSize);

//   // If we have less than 3 in the last group, we pad with empty?
//   // Or we can show all remaining.

//   // Better: show a slider with 3 cards at a time, but we need to handle dots.
//   // Let's simplify: show all members in a row with translateX based on index * (cardWidth + gap)
//   // Using flex and overflow hidden.

//   const cardWidth = 260; // approximate width of each card in px
//   const gap = 24;
...
//               <div
//                 key={idx}
//                 className="flex-shrink-0 w-[260px] mx-3"
...
//               <button
//                 onClick={goToPrev}
//                 className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 backdrop-blur-sm rounded-full p-3 shadow-lg border border-gray-200 hover:bg-red-600 hover:text-white transition-all duration-300"
//                 aria-label="Previous"
//               >
...
//               <button
//                 onClick={goToNext}
//                 className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 backdrop-blur-sm rounded-full p-3 shadow-lg border border-gray-200 hover:bg-red-600 hover:text-white transition-all duration-300"
//                 aria-label="Next"
//               >
